...
impl IasClient {
    ...
    pub fn new(url: String, cert: Vec<u8>, time: Option<u64>) -> Self {
        IasClient {
            ias_url: url,
            spid_cert: cert,
    ...
    pub fn get_signature_revocation_list(
        ...
        let client = get_client(self.spid_cert.as_slice())
            .expect("Eror creating http/s client");
...
mod tests {
    ...
    fn test_new_ias_client_with_assignment() {
        ...
        default_client.set_spid_cert(DUMMY_CERT.clone());
