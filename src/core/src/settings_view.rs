...
impl Poet2SettingsView {
    ...
    pub fn _get_config_value_as_u64(&self, config_key: &str, in_default_value: u64) -> u64 {
    ...
    pub fn _get_config_value_as_f64(&self, config_key: &str, in_default_value: f64) -> f64 {
        if let Some(raw_value) = self.settings.get(config_key) {
